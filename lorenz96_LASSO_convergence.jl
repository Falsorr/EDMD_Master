...
# It will compute the data for the convergence plot of the LASSO
...
# Save the data
save("LASSO_data_run_4.jld2", "K_list", 𝒦_list, "residual_list", residual_list, "undersampling_rate", undersampling_rate, "mean_validation_residuals_list", mean_res_val, "std_validation_residuals_list", std_res_val)
